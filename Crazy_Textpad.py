...
class TextPad:
    def __init__(self, root):
        self.window = root
        self.window.title(f"Crazy TextPad")
    ...
    def __menu_decor(self):# Menu decorating function
        ...
        customization_underline_img = ImageTk.PhotoImage(Image.open("underline_img.png").resize((30,30), Image.LANCZOS))
        customization_foreground_color_img = ImageTk.PhotoImage(Image.open("font_color.png").resize((30,30), Image.LANCZOS))
        customization_background_color_img = ImageTk.PhotoImage(Image.open("background_color.png").resize((30,30), Image.LANCZOS))

        # Menu Make
        self.file_menu = Menu(menu_control,tearoff=False)
        menu_control.add_cascade(label="File",menu=self.file_menu)
        self.file_menu.add_command(label="New", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="(Ctrl+N)", compound=LEFT, image=file_new_img, command=self.new_window)
        self.file_menu.add_command(label="Open", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="(Ctrl+O)", compound=LEFT, image=file_open_img, command=self.open_another_file)
        self.file_menu.add_separator(background="paleturquoise")
        self.file_menu.add_command(label="Save", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), compound=LEFT, image=file_save_img, command=self.save)
        self.file_menu.add_command(label="Save As", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="(Ctrl+S)", compound=LEFT, image=file_save_img, command=self.save_as)
        self.file_menu.add_command(label="Save File as PDF", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="(Alt+P)", compound=LEFT, image=file_pdf_img, command=self.save_file_as_pdf)
        self.file_menu.add_separator(background="paleturquoise")
        self.file_menu.add_command(label="Print", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="(Ctrl+P)", compound=LEFT, image=file_print_img, command=self.print_a_file)
        self.file_menu.add_command(label="Exit", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="ESC", compound=LEFT, image=file_exit_img, command=self.take_exit)
        ...
        self.edit_menu.add_command(label="Undo", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+Z)", compound=LEFT, image=edit_undo_img, command=self.undo)
        self.edit_menu.add_command(label="Redo", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+Y)", compound=LEFT, image=edit_redo_img, command=self.redo)
        self.edit_menu.add_separator(background="paleturquoise")
        self.edit_menu.add_command(label="Cut", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+X)", compound=LEFT, image=edit_cut_img, command=self.cut)
        self.edit_menu.add_command(label="Copy", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+C)", compound=LEFT, image=edit_copy_img)
        self.edit_menu.add_command(label="Paste", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+V)", compound=LEFT, image=edit_paste_img, command=self.paste)
        self.edit_menu.add_separator(background="paleturquoise")
        self.edit_menu.add_command(label="Clear", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), compound=LEFT, image=edit_clear_img, command=self.clear)
        ...
        self.view_menu.add_command(label="Find", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+F)", compound=LEFT, image=view_find_img, command=self.find_UI)
        self.view_menu.add_command(label="Replace", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+R)", compound=LEFT, image=view_replace_img, command=self.replace_UI)
        self.view_menu.add_separator(background="paleturquoise")
        self.view_menu.add_command(label="Dark Mode", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), compound=LEFT, image=view_dark_img, command=self.dark_mode)
        self.view_menu.add_command(label="Light Mode", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), compound=LEFT, image=view_light_img, command=self.light_mode)
        ...
        self.customization_menu.add_command(label="Bold", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+B)", compound=LEFT, image=customization_bold_img, command=self.change_bold)
        self.customization_menu.add_command(label="Italics", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+I)", compound=LEFT, image=customization_italic_img, command=self.change_italic)
        self.customization_menu.add_command(label="Underline", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+U)", compound=LEFT, image=customization_underline_img, command=self.change_underline)
        self.customization_menu.add_separator(background="paleturquoise")
        self.customization_menu.add_command(label="Foreground-Color", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Alt+F)", compound=LEFT, image=customization_foreground_color_img, command=self.change_fg_color)
        self.customization_menu.add_command(label="Background-Color", background="paleturquoise", foreground="black", activebackground="black", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Alt+F)", compound=LEFT, image=customization_foreground_color_img, command=self.change_fg_color)
    ...
    def __header_1_decoration(self):
        ...
        # Instructional Label
        self.font_size_label = Label(self.header_1, text="Font Size", font=("Arial",15,"bold"), bg="black", fg="brown")
        self.font_size_label.place(x=5,y=50)
        self.alignment_label = Label(self.header_1, text="Alignment", font=("Arial",15,"bold"), bg="black", fg="brown")
    ...
    def __acc_decoration(self):# Account Section Decoration
        ...
        # Image Bringing
        log_img = ImageTk.PhotoImage(Image.open("login_image.png").resize((50, 50), Image.LANCZOS))
        sign_up_img = ImageTk.PhotoImage(Image.open("sign_up_image.png").resize((50, 50), Image.LANCZOS))
        history_img = ImageTk.PhotoImage(Image.open("history_check.png").resize((35, 35), Image.LANCZOS))
        log_out_img =  ImageTk.PhotoImage(Image.open("log_out_img.png").resize((35, 35), Image.LANCZOS))
    ...
    def __history_check_options(self):# Account History Checking
        ...
        searching_google = Button(top, text="Google Search History", font=("Arial", 25, "bold", "italic"), bg="#141414", fg="black", relief=RAISED, bd=5, activebackground="green", activeforeground="gold", command=lambda :self.__history_viewer(2))
    ...
    def light_mode(self):
        ...
        self.font_size_label.config(bg="black", fg="brown")
        self.alignment_label.config(bg="black", fg="brown")
        ...
        for every in self.status_components:
            every.config(bg="black", fg="brown")
    ...
    def ui_for_searching(self):
        ...
        try:
            ...
            youtube_search = Button(top, text="Search in Youtube", font=("Arial", 25, "bold", "italic"), bg="#262626", fg="black", relief=RAISED, bd=5, activebackground="green", activeforeground="gold", command=lambda: searching_option("Youtube", get_text))
