...
class TextPad:
    ...
    def __status(self):  # Status Section Make
        self.status_1 = Label(self.window, text="Total Word: 0", font=("Arial", 10, "bold"), bg="gold", fg="brown",
                              relief=RIDGE, bd=3, width=40, height=1)
        self.status_1.place(x=0, y=90)

        self.status_2 = Label(self.window, text="Total Line: 0", font=("Arial", 10, "bold"), bg="gold", fg="brown",
                              relief=RIDGE, bd=3, width=46, height=1)
        self.status_2.place(x=325, y=90)

        self.status_3 = Label(self.window, text=f"Working Time: 00:00:00", font=("Arial", 10, "bold"), bg="gold",
                              fg="brown", relief=RIDGE, bd=3, width=46, height=1)
        self.status_3.place(x=(325 + 325) + 3, y=90)

        self.status_4 = Label(self.window, text="Account holder name: ", font=("Arial", 10, "bold"), bg="gold",
                              fg="brown", relief=RIDGE, bd=3, width=41, height=1)
    ...
    def __header_1_decoration(self):
        ...
        # Instructional Label
        self.font_size_label = Label(self.header_1, text="Font Size", font=("Arial", 15, "bold"), bg="black",
                                     fg="brown")
        self.font_size_label.place(x=5, y=50)
        self.alignment_label = Label(self.header_1, text="Alignment", font=("Arial", 15, "bold"), bg="black",
                                     fg="brown")
    ...
    def __header_2_decoration(self):
        ...
        bullet_collection = ttk.Combobox(self.header_2, width=30, values=total_bullets, foreground="brown",
    ...
    def __header_4_decoration(self):
        ...
        op = Button(self.header_4, width=35, height=30, image=paint_image, font=("Arial", 11, "bold"), bg="#00FF00",
                    relief=RAISED, bd=3, command=TextPad.connect_drawing_app)
        op.place(x=230, y=45)
    ...
    def __acc_decoration(self):  # Account Section Decoration
        ...
        # Instructional buttons
        log_in_btn = Button(self.acc, width=35, height=30, image=log_img, bg="#008080", relief=RAISED, bd=3,
                            command=self.__log_in)
        log_in_btn.place(x=10, y=0)

        sign_up_btn = Button(self.acc, width=35, height=30, image=sign_up_img, bg="#008080", relief=RAISED, bd=3,
                             command=self.__sign_up)
        sign_up_btn.place(x=10, y=45)

        history_btn = Button(self.acc, width=35, height=30, image=history_img, bg="#008080", relief=RAISED, bd=3,
                             command=self.__history_check_options, state=DISABLED)
        history_btn.place(x=80, y=0)

        log_out_btn = Button(self.acc, width=35, height=30, image=log_out_img, bg="#008080", relief=RAISED, bd=3,
                             command=self.__log_out, state=DISABLED)
    ...
    def __sign_up(self):
        ...
        Label(top, text="-:Enter the Storage Password to Unlock:-", font=("Arial", 25, "bold", "italic"), bg="#262626",
              fg="gold").place(x=100, y=100)

        db_pwd_take = Entry(top, width=26, font=("Arial", 18, "bold", "italic"), bg="#262626", fg="#d6b575",
                            relief=SUNKEN, bd=5, show="*")
        ...
        visibility = Button(top, text="Show", font=("Arial", 18, "bold", "italic"), bg="#262626", fg="#FF4500",
                            relief=RAISED, bd=1, command=change_visibility_db_pwd)
        visibility.place(x=580, y=160)

        Label(top, text="-:Enter New Account name:-", font=("Arial", 25, "bold", "italic"), bg="#262626",
              fg="gold").place(x=160, y=80 + 150)
        acc_name_take = Entry(top, width=23, font=("Arial", 25, "bold", "italic"), bg="#262626", fg="#d6b575",
                              relief=SUNKEN, bd=5)
        acc_name_take.place(x=180, y=140 + 150)

        Label(top, text="-:Enter Password:-", font=("Arial", 25, "bold", "italic"), bg="#262626", fg="gold").place(
            x=240, y=220 + 150)
        pwd_entry = Entry(top, width=16, font=("Arial", 25, "bold", "italic"), bg="#262626", fg="#d6b575",
                          relief=SUNKEN, bd=5, show="*")
        ...
        visibility_other = Button(top, text="Show", font=("Arial", 18, "bold", "italic"), bg="#262626", fg="#00FF00",
                                  relief=RAISED, bd=2, command=change_visibility_acc_pwd)
        visibility_other.place(x=550, y=270 + 150)

        conform_btn = Button(top, text="Make Account", font=("Arial", 15, "bold", "italic"), bg="#262626", fg="#FF0000",
                             relief=RAISED, bd=5,
                             command=lambda: self.__mysql_entry_for_sign_up(top, db_pwd_take.get(), acc_name_take.get(),
                                                                            pwd_entry.get()))
    ...
    def __mysql_entry_for_sign_up(self, input_window, db_pwd, acc_name, acc_pwd):
        ...
        try:
            ...
            take_values = (
            1, acc_pwd, "01/01/2020", "Nothing", 0, 0, "Nothing To Show", "Nothing To Show", "Nothing To Show",
    ...
    def __log_in(self):
        ...
        Label(top, text="-:Enter the Storage Password to Unlock:-", font=("Arial", 25, "bold", "italic"), bg="#141414",
              fg="gold").place(x=80, y=100)

        db_pwd_take = Entry(top, width=26, font=("Arial", 18, "bold", "italic"), bg="#141414", fg="#d6b575",
                            relief=SUNKEN, bd=5, show="*")
        ...
        visibility = Button(top, text="Show", font=("Arial", 18, "bold", "italic"), bg="#141414", fg="#FF4500",
                            relief=RAISED, bd=1, command=change_visibility_db_pwd)
        visibility.place(x=580, y=160)

        Label(top, text="-:Enter Existing Account name:-", font=("Arial", 25, "bold", "italic"), bg="#141414",
              fg="gold").place(x=140, y=80 + 150)
        acc_name_take = Entry(top, width=23, font=("Arial", 25, "bold", "italic"), bg="#141414", fg="#d6b575",
                              relief=SUNKEN, bd=5)
        acc_name_take.place(x=180, y=140 + 150)

        Label(top, text="-:Enter Account Password:-", font=("Arial", 25, "bold", "italic"), bg="#141414",
              fg="gold").place(x=160, y=220 + 150)
        pwd_entry = Entry(top, width=16, font=("Arial", 25, "bold", "italic"), bg="#141414", fg="#d6b575",
                          relief=SUNKEN, bd=5, show="*")
        ...
        visibility_other = Button(top, text="Show", font=("Arial", 18, "bold", "italic"), bg="#141414", fg="#00FF00",
                                  relief=RAISED, bd=2, command=change_visibility_acc_pwd)
        visibility_other.place(x=550, y=270 + 150)

        conform_btn = Button(top, text="Activate Account", font=("Arial", 15, "bold", "italic"), bg="#262626",
                             fg="#FF0000", relief=RAISED, bd=5,
                             command=lambda: self.__mysql_entry_for_log_in(top, db_pwd_take.get(), acc_name_take.get(),
                                                                           pwd_entry.get()))
        conform_btn.place(x=300, y=340 + 180)
    ...
    def __log_out(self):
        ...
        take_values = (self.record_no, self.pwd_acc, f"{d}/{m}/{y}", working_time_is, self.total_word, self.total_line,
                       saved_file_name, self.searching_things_in_google, self.send_msg_to_wp, self.pdf_saved_file_name,
                       self.saved_file_name_in_google_drive)
        switch_cur.execute(take_input, take_values)
        access_old.commit()
    ...
    def __time_counter(self):
        ...
        if self.get_time > -1:
            ...
            self.status_components[2].after(1000,
                                            self.__time_counter)  # Recursive function call after 1 sec = 1000 milisecond
        else:
            self.status_components[2]['text'] = "Working Time: 00:00:00"
