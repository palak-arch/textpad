...
import Sketch_With_Sam as Drawing_app
    ...
    def __menu_decor(self):# Menu decorating function
        ...
        file_new_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\new_img.jpg").resize((30,30), Image.LANCZOS))
        file_open_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\open_img.jpg").resize((30,30), Image.LANCZOS))
        file_save_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\save_img.png").resize((30,30), Image.LANCZOS))
        file_pdf_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\pdf_text.jpg").resize((30,30), Image.LANCZOS))
        file_print_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\print_img.png").resize((30,30), Image.LANCZOS))
        file_exit_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\exit_img.png").resize((30,30), Image.LANCZOS))

        edit_undo_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\undo_img.jpg").resize((30,30), Image.LANCZOS))
        edit_redo_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\redo_icon.png").resize((30,30), Image.LANCZOS))
        edit_cut_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\cut_img.png").resize((30,30), Image.LANCZOS))
        edit_copy_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\copy_img.jpg").resize((30,30), Image.LANCZOS))
        edit_paste_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\paste_img.jpg").resize((30,30), Image.LANCZOS))
        edit_clear_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\clear_img.png").resize((30,30), Image.LANCZOS))

        view_find_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\magnifier.jpg").resize((30,30), Image.LANCZOS))
        view_replace_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\replace_icon.png").resize((30,30), Image.LANCZOS))
        view_dark_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\dark_mode_img.png").resize((30,30), Image.LANCZOS))
        view_light_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\bulb_img.jpg").resize((30,30), Image.LANCZOS))

        customization_bold_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\bold_img.jpg").resize((30,30), Image.LANCZOS))
        customization_italic_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\italic_img.png").resize((30,30), Image.LANCZOS))
        customization_underline_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\underline_img.png").resize((30,30), Image.LANCZOS))
        customization_foreground_color_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\font_color.png").resize((30,30), Image.LANCZOS))
        customization_background_color_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\background_color.png").resize((30,30), Image.LANCZOS))

        # Menu Make
        self.file_menu = Menu(menu_control,tearoff=False)
        menu_control.add_cascade(label="File",menu=self.file_menu)
        self.file_menu.add_command(label="New", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="(Ctrl+N)", compound=LEFT, image=file_new_img, command=self.new_window)
        self.file_menu.add_command(label="Open", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="(Ctrl+O)", compound=LEFT, image=file_open_img, command=self.open_another_file)
        self.file_menu.add_separator(background="paleturquoise")
        self.file_menu.add_command(label="Save", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), compound=LEFT, image=file_save_img, command=self.save)
        self.file_menu.add_command(label="Save As", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="(Ctrl+S)", compound=LEFT, image=file_save_img, command=self.save_as)
        self.file_menu.add_command(label="Save File as PDF", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="(Alt+P)", compound=LEFT, image=file_pdf_img, command=self.save_file_as_pdf)
        self.file_menu.add_separator(background="paleturquoise")
        self.file_menu.add_command(label="Print", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="(Ctrl+P)", compound=LEFT, image=file_print_img, command=self.print_a_file)
        self.file_menu.add_command(label="Exit", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial",10,"bold","italic"), accelerator="ESC", compound=LEFT, image=file_exit_img, command=self.take_exit)
        ...
        self.edit_menu.add_command(label="Undo", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+Z)", compound=LEFT, image=edit_undo_img, command=self.undo)
        self.edit_menu.add_command(label="Redo", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+Y)", compound=LEFT, image=edit_redo_img, command=self.redo)
        self.edit_menu.add_separator(background="paleturquoise")
        self.edit_menu.add_command(label="Cut", background="paleturquoise", foreground="Yellow", activebackground="yellow",                 activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+X)", compound=LEFT, image=edit_cut_img, command=self.cut)
        self.edit_menu.add_command(label="Copy", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+C)", compound=LEFT, image=edit_copy_img)
        self.edit_menu.add_command(label="Paste", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+V)", compound=LEFT, image=edit_paste_img, command=self.paste)
        self.edit_menu.add_separator(background="paleturquoise")
        self.edit_menu.add_command(label="Clear", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), compound=LEFT, image=edit_clear_img, command=self.clear)
        ...
        self.view_menu.add_command(label="Find", background="paleturquoise", foreground="Yellow", activebackground="yellow",    activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+F)", compound=LEFT, image=view_find_img, command=self.find_UI)
        self.view_menu.add_command(label="Replace", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+R)", compound=LEFT, image=view_replace_img, command=self.replace_UI)
        self.view_menu.add_separator(background="paleturquoise")
        self.view_menu.add_command(label="Dark Mode", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), compound=LEFT, image=view_dark_img, command=self.dark_mode)
        self.view_menu.add_command(label="Light Mode", background="paleturquoise", foreground="Yellow", activebackground="yellow",       activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), compound=LEFT, image=view_light_img, command=self.light_mode)
        ...
        self.customization_menu.add_command(label="Bold", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+B)", compound=LEFT, image=customization_bold_img, command=self.change_bold)
        self.customization_menu.add_command(label="Italics", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+I)", compound=LEFT, image=customization_italic_img, command=self.change_italic)
        self.customization_menu.add_command(label="Underline", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Ctrl+U)", compound=LEFT, image=customization_underline_img, command=self.change_underline)
        self.customization_menu.add_separator(background="paleturquoise")
        self.customization_menu.add_command(label="Foreground-Color", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Alt+F)", compound=LEFT, image=customization_foreground_color_img, command=self.change_fg_color)
        self.customization_menu.add_command(label="Background-Color", background="paleturquoise", foreground="Yellow", activebackground="yellow", activeforeground="paleturquoise", font=("Arial", 10, "bold", "italic"), accelerator="(Alt+B)", compound=LEFT, image=customization_background_color_img, command=self.change_bg_color)
    ...
    def __header_1_decoration(self):
        ...
        # Image bringing
        l_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\align.png").resize((50, 50), Image.LANCZOS))
        m_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\m_align.png").resize((50, 50), Image.LANCZOS))
        r_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\r_align.png").resize((50, 50), Image.LANCZOS))


        # Font Size Controller Scale
        font_size_controller = Scale(self.header_1, font=("Arial",10,"bold"), width=15, orient=HORIZONTAL, background="paleturquoise", foreground="gold", from_=1, to=100, activebackground="black", relief=RAISED, bd=2, command=self.change_font_size)
        ...
        # Instructional Label
        self.font_size_label = Label(self.header_1, text="Font Size", font=("Arial",15,"bold"), bg="darkcyan", fg="black")
        self.font_size_label.place(x=5,y=50)
        self.alignment_label = Label(self.header_1, text="Alignment", font=("Arial",15,"bold"), bg="darkcyan", fg="black")
    ...
    def __header_3_decoration(self):
        ...
        # Image bringing
        u_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\U.png").resize((50, 50), Image.LANCZOS))
        lc_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\L.png").resize((50, 50), Image.LANCZOS))
        g_search_image = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\g_search.png").resize((50, 50), Image.LANCZOS))
        find_image_take = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\magnifier.jpg").resize((50, 30), Image.LANCZOS))
        replace_image_take = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\replace_icon.png").resize((50, 30), Image.LANCZOS))
    ...
    def __header_4_decoration(self):
        ...
        # Image Bringing
        pdf_txt_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\pdf_text_btn.jpg").resize((50, 50), Image.LANCZOS))
        dark_mode_img_take = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\dark_mode_img.png").resize((50, 50), Image.LANCZOS))
        wp_logo_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\wp_logo.jpg").resize((50, 50), Image.LANCZOS))
        wiki_img = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\wiki.png").resize((50, 50), Image.LANCZOS))
        light_mode_image = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\bulb_img.jpg").resize((40, 40), Image.LANCZOS))
        paint_image = ImageTk.PhotoImage(Image.open("C:\\Users\\pallak sharma\\OneDrive\\Desktop\\textpad1\\textpad\\pencil.png").resize((30, 30), Image.LANCZOS))
        ...
        g = Button(self.header_4, width=35, height=30, image=wp_logo_img, bg="paleturquoise", relief=RAISED, bd=3, command=self.send_msg_to_whatsapp)
        g.place(x=230, y=0)
    ...
    def __history_check_options(self):# Account History Checking
        ...
        general_information = Button(top, text="General Information", font=("Arial", 25, "bold", "italic"), bg="#141414", fg="#FF0000", relief=RAISED, bd=5, activebackground="paleturquoise", activeforeground="gold", command=lambda :self.__history_viewer(1))
        general_information.pack(pady=20)

        searching_google = Button(top, text="Google Search History", font=("Arial", 25, "bold", "italic"), bg="#141414", fg="yellow", relief=RAISED, bd=5, activebackground="paleturquoise", activeforeground="gold", command=lambda :self.__history_viewer(2))
        searching_google.pack(pady=20)

        send_msg_to_wp = Button(top, text="Whatsapp Messages", font=("Arial", 25, "bold", "italic"), bg="#141414", fg="#00FF00", relief=RAISED, bd=5, activebackground="paleturquoise", activeforeground="gold", command=lambda :self.__history_viewer(3))
        send_msg_to_wp.pack(pady=20)

        pdf_saved_file_name = Button(top, text="Saved PDF file names", font=("Arial", 25, "bold", "italic"), bg="#141414", fg="magenta", relief=RAISED, bd=5, activebackground="paleturquoise", activeforeground="gold", command=lambda :self.__history_viewer(4))
        pdf_saved_file_name.pack(pady=20)

        file_save_in_google_drive = Button(top, text="Saved file names in google drive", font=("Arial", 25, "bold", "italic"), bg="#141414", fg="chocolate", relief=RAISED, bd=5, activebackground="paleturquoise", activeforeground="gold", command=lambda :self.__history_viewer(5))
    ...
    messagebox.showinfo("Log-Out", "You are logged out from your current account")
    ...
    def dark_mode(self):
        self.main_writing_space.config(bg="#0d0d0d", fg="#00FF00", insertbackground="paleturquoise", selectbackground="#8989ff")
    ...
    def light_mode(self):
        ...
        self.font_size_label.config(bg="darkcyan", fg="brown")
        self.alignment_label.config(bg="darkcyan", fg="brown")
        self.header_1_components[0].config(bg="paleturquoise")
        ...
        for every in self.status_components:
            every.config(bg="darkcyan", fg="brown")

        self.file_menu.entryconfig("New", background="paleturquoise", foreground="Yellow")
        self.file_menu.entryconfig("Open", background="paleturquoise", foreground="Yellow")
        self.file_menu.entryconfig("Save", background="paleturquoise", foreground="Yellow")
        self.file_menu.entryconfig("Save As", background="paleturquoise", foreground="Yellow")
        self.file_menu.entryconfig("Save File as PDF", background="paleturquoise", foreground="Yellow")
        self.file_menu.entryconfig("Print", background="paleturquoise", foreground="Yellow")
        self.file_menu.entryconfig("Exit", background="paleturquoise", foreground="Yellow")
        self.file_menu.delete(2)
        self.file_menu.delete(5)
        self.file_menu.insert_separator(2, background="paleturquoise")
        self.file_menu.insert_separator(6, background="paleturquoise")

        self.edit_menu.entryconfig("Undo", background="paleturquoise", foreground="Yellow")
        self.edit_menu.entryconfig("Redo", background="paleturquoise", foreground="Yellow")
        self.edit_menu.entryconfig("Cut", background="paleturquoise", foreground="Yellow")
        self.edit_menu.entryconfig("Copy", background="paleturquoise", foreground="Yellow")
        self.edit_menu.entryconfig("Paste", background="paleturquoise", foreground="Yellow")
        self.edit_menu.entryconfig("Clear", background="paleturquoise", foreground="Yellow")
        self.edit_menu.delete(2)
        self.edit_menu.delete(5)
        self.edit_menu.insert_separator(2, background="paleturquoise")
        self.edit_menu.insert_separator(6, background="paleturquoise")

        self.view_menu.entryconfig("Find", background="paleturquoise", foreground="Yellow")
        self.view_menu.entryconfig("Replace", background="paleturquoise", foreground="Yellow")
        self.view_menu.entryconfig("Dark Mode", background="paleturquoise", foreground="Yellow")
        self.view_menu.entryconfig("Light Mode", background="paleturquoise", foreground="Yellow")
        self.view_menu.delete(2)
        self.view_menu.insert_separator(2, background="paleturquoise")

        self.customization_menu.entryconfig("Bold", background="paleturquoise", foreground="Yellow")
        self.customization_menu.entryconfig("Italics", background="paleturquoise", foreground="Yellow")
        self.customization_menu.entryconfig("Underline", background="paleturquoise", foreground="Yellow")
        self.customization_menu.entryconfig("Foreground-Color", background="paleturquoise", foreground="Yellow")
        self.customization_menu.entryconfig("Background-Color", background="paleturquoise", foreground="Yellow")
        self.customization_menu.delete(3)
        self.customization_menu.insert_separator(3, background="paleturquoise")
    ...
    def ui_for_searching(self):
        ...
        try:
            ...
            google_search = Button(top, text="Search in Google", font=("Arial", 25, "bold", "italic"), bg="#262626", fg="#FF0000", relief=RAISED, bd=5, activebackground="paleturquoise", activeforeground="gold", command=lambda: searching_option("Google", get_text))
            google_search.pack(pady=20)

            youtube_search = Button(top, text="Search in Youtube", font=("Arial", 25, "bold", "italic"), bg="#262626", fg="yellow", relief=RAISED, bd=5, activebackground="paleturquoise", activeforeground="gold", command=lambda: searching_option("Youtube", get_text))
            youtube_search.pack(pady=20)

            facebook_search = Button(top, text="Search in Facebook", font=("Arial", 25, "bold", "italic"), bg="#262626", fg="#00FF00", relief=RAISED, bd=5, activebackground="paleturquoise", activeforeground="gold", command=lambda: searching_option("Facebook", get_text))
            facebook_search.pack(pady=20)

            linkedin_search = Button(top, text="Search in LinkedIn", font=("Arial", 25, "bold", "italic"), bg="#262626", fg="magenta", relief=RAISED, bd=5, activebackground="paleturquoise", activeforeground="gold", command=lambda: searching_option("Linkedin", get_text))
            linkedin_search.pack(pady=20)

            instagram_search = Button(top, text="Search in Instagram", font=("Arial", 25, "bold", "italic"), bg="#262626", fg="chocolate",            relief=RAISED, bd=5, activebackground="paleturquoise", activeforeground="gold", command=lambda: searching_option("Instagram", get_text))
